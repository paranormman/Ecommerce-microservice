...
import com.vestaChrono.ecommerce.inventory_service.clients.OrdersFeignClient;
...
//                .body(String.class);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> restoreStock(@RequestBody OrderRequestDto orderRequestDto) {
